...
[Android版本实现](https://github.com/Ernest-su/LinuxCmd.git) | [Alfred 版本下载](https://github.com/jaywcjlove/linux-command/releases) 
...
[![Linux 命令大全](./alfred.gif)](https://github.com/jaywcjlove/linux-command/releases)
