...
`linux-command` 是一个收录了大量linux命令的中文手册的项目，以markdown的格式存储
...
```bash
curl -fsSL https://raw.githubusercontent.com/IridiumNan/linux-command/master/install.sh | bash
```
